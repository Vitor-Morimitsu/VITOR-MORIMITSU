...
void lerGeo(FILE* arqGeo, FILE* arqSVG ,FILE* arqDestino){
    if(arqGeo == NULL){
    ...
    while(fgets(linha, sizeof(linha), arqGeo) != NULL){
        ...
        if (tipoForma == 'c') {
            ...
            novaForma = criaCirculoForma(i, x, y, r, corb, corp);
            ...
            novaForma = criaRetanguloForma(i, x, y, w, h, corb, corp);
            ...
            novaForma = criarLinha(i, x1,y1,x2,y2,cor);
        } else if( tipoForma == 't'){
            int i;
            double x, y;
            ...
            novaForma = criaTextoForma(i,x,y,corb,corp,a,texto,NULL);
        }
    }
